...
<div class="mainContainer">
    <div id="previewContainer">
        <video id="previewVideo" width="300" height="300" controls autoplay></video>
    </div>
    <div id="buttonContainer">
       <form id="videoForm" action="" method="post" enctype="multipart/form-data">
            <label for="videoUpload" class="Capbut">Capture Video</label>
            <input type="file" name="video" accept="video/*" capture="environment" id="videoUpload" onchange="previewVideo(event)">
